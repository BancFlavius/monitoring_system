...
#echo "Build apk finish!!!\n" >> build_output.txt
#./gradlew app:assembleAndroidTest >> build_output.txt 2>&1
#echo "assembleAndroidTest finish!!!\n" >> build_output.txt
#./gradlew app:assembleDebug -Ptarget=integration_test/admin_test.dart >> build_output.txt 2>&1
#echo "app_test finish!!!\n" >> build_output.txt
#popd


gcloud auth activate-service-account --key-file=attendance-6dcd9-0d415afc90dc.json

gcloud --quiet config set project attendance-6dcd9
